...
## [4.0.1] - 2025-07-22
### Changed
- Implemented selective instruction delete

## [4.0.0] - 2025-01-14
### Changed
- Updated certifi, requests, and python for security

## [3.1.0] - 2024-12-16
### Changed
- Implemented key disk lookup by label with a fallback to legacy `/dev/vdb` device
